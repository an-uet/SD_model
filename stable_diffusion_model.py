...
class StableDiffusion(nn.Module):
    def __init__(self, in_channels=3, latent_dim=4, image_size=256, diffusion_timesteps=1000, device="cuda"):
    ...
    def load_diffusion(self, diffusion_path):
        self.unet.load_state_dict(torch.load(diffusion_path, map_location=torch.device('cpu')))
...
def load_model(pth_path, in_channels=3, latent_dim=4, image_size=512, diffusion_timesteps=1000, device="cuda"):
